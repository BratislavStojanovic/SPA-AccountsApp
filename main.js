...
function createAccountsTable() {
  ...
  for (let i = 0; i < db.length; i++) {
    ...
    <td>${account.email}</td>
    <td>${account.phone}</td>
    <td><button data-id="${i}" class="edit-btn btn btn-sm btn-warning">Edit</button></td>
    <td><button data-id="${i}" class="delete-btn btn btn-sm btn-danger">Delete</button></td>
  </tr>
    
    `;
  }
  tbodyData.innerHTML = htmlAccounts;
